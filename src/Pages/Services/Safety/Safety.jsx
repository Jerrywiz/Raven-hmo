        ...
        <Row>
          <Col md={12} lg={8} className="text-center">
            ...
            <p className="w-50 m-auto content-inner">
              Since 1998, we have been proud to combine modern techniques and
              high-tech equipment. Dr. John Dae, Micha and his team deliver a
              personalized and comfortable health care experience unlike any
              other HMO.
            </p>
          </Col>
        </Row>
