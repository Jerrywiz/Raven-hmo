                    ...
                    <Row>
                        <Col md={7} lg={8}>
                            <div className="single-dentist-details">
                                <h2>Dr. Adewale Helen <span>(DMD, MS, DICOI)</span></h2>
                            ...
                            <div className="dentist-award">
                                ...
                                <ul className="p-0">
                                    <li>Nigeria Doctor  Association</li>
                      
                                    <li>Lagos  health Society</li>
                                    <li>Academy of General Dentistry</li>
                                    <li>Nigeria  Association of Women Doctos</li>
                                </ul>
                            </div>
                        </Col>
                        <Col md={5} lg={4}>
                            <div className="dentist-profile text-center">
                                ...
                                <p>Name: <strong>Adewale Aminu</strong></p>
